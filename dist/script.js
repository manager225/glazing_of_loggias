...
var forms = function forms(state) {
  ...
  var message = {
    loading: 'Загрузка...',
    success: 'Спасибо! Мы свяжемся с вами в течение 10 минут.',
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (e) {
    ...
    if (e.target && (target.classList.contains(tabSelector.replace(/\./, "")) || target.parentNode.classList.contains(tabSelector.replace(/\./, "")))) {
